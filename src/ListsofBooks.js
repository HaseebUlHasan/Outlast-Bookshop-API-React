      ...
      <div>
          ...
          actions={[
            {
              ...
              onClick: (event, rowData) =>
                navigate(`/BookDetail/${rowData.id}`),
            },
          ]}
          options={{
            filtering: true,
        ...
        <div style={{ marginTop: "20px", marginLeft: "1150px" }}>
         <Button className="btn btn-primary" onClick={loadMore}>
          ...
          <Button className="btn btn-primary mx-3" onClick={loadLess}>
            Load Less Books
          </Button>
        </div>
      </div>
